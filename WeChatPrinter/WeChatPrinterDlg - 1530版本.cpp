...
{
	BOOL b1 = StartProcess(strpath, "", 0, 0);
	if (b1 == FALSE)
	{
		BOOL b2 = StartProcess2(strpath, FALSE);
		LOG(LOGTYPE_ERROR, LOG_NAME_DEBUG, "StartProcess3", "StartProcess 失效，启动StartProcess2 %d,%d", b1, b2);
	}
	return TRUE;
}