...
Status compress_image(std::string orig_fiepath, std::string backup_folder,unsigned int maxWidth = 4096, unsigned int maxHeight = 4096, unsigned long quality = 65)
{
